...
{/* <InfoCard/> */}
  ...
  <div className="relative w-full min-h-[400px] md:min-h-[600px]">
    <video 
      ...
      autoPlay 
      playsInline
      className="non-mirrored-video border-4 border-green-600 border-opacity-20 rounded-lg w-full h-full object-cover"
    />
    {!isPeerConnected && isJoined && (
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 bg-opacity-95 rounded-lg backdrop-blur-sm p-4">
    ...
    {/* Local Video - Floating Bottom Right (Picture-in-Picture) */}
    <div className="absolute bottom-4 right-4 w-32 h-40 md:w-48 md:h-56 shadow-2xl z-10">
      <video 
        ref={localVideoRef} 
        autoPlay 
        playsInline 
        muted 
        className="non-mirrored-video border-4 border-green-600 border-opacity-30 rounded-lg w-full h-full object-cover"
      />
      {!isCameraOn && isJoined && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-lg">
          <svg className="w-8 h-8 md:w-12 md:h-12 text-gray-400 mb-1 md:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
